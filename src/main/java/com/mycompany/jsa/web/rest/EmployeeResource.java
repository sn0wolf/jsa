...
import com.mycompany.jsa.domain.Employee;
import com.mycompany.jsa.repository.EmployeeRepository;
...
/**
 * REST controller for managing {@link com.mycompany.jsa.domain.Employee}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class EmployeeResource {
    ...
    private static final String ENTITY_NAME = "jsaEmployee";
